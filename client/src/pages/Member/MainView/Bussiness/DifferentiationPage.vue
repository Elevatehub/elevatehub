...
export default {
  ...
  methods: {
    ...
    async onSearch(e) {
      this.isLoading = true
      e.preventDefault()
      const payload = `Sebagai seorang analist produk, sebutkan perbedaan produk atau unikness dari ${e.target[0].value} yang bergerak di bidang ${e.target[1].value} dengan kompetitor di pasar indonesia`
      try {

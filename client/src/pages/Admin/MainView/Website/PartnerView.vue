<template>
    <div>
        ...
        <br />
        <br />
        <v-btn color="blue" v-if="hide && !scraping" @click="addItem()">Add Partner</v-btn>
        <br />
        <br />
            ...
            <v-card style="padding: 5%;">
                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            <v-col cols="12">
                                <v-text-field v-model="headerChild" label="Header" required></v-text-field>
                                <v-text-field v-model="valueChild" label="Value" required></v-text-field>
                                <v-text-field v-model="iconChild" label="Icon" required></v-text-field>
                            </v-col>
                        </v-row>
                    </v-container>
                </v-card-text>
...
export default {
    ...
    methods: {
        ...
        async getTopics() {
            ...
            try {
                const data = await websiteService.websiteLogin('5')
